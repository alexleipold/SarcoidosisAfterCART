...
filedir <- "/home/alexander/Data/members/Alexander_Leipold/projects/Leo_Rasche/MM_Case_Report/Revision/13_05_22/datasets/GarmanSarc_3.1.0/"

datasets <- c("donor3", "donor4", "donor5", "donor6", "donor7",
              "donor8", "donor10", "donor11", "donor12", "donor13")
